...
#+DATE: CARLA 2026 Advanced Tutorial @@latex:\\ {\small \url{https://github.com/schnorr/starpu-tutorial}}@@
...
** Setup — start this now, it takes a while

All tutorial material (slides, handouts, exercises, solutions):

https://github.com/schnorr/starpu-tutorial

We will use *Podman* throughout (rootless, no background daemon needed
...
This image is *~8 GB* — start the pull *now*, during this lecture, on
