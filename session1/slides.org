...
See =../../roteiro-minicurso.org= (in the project repository this
package was generated from) for how this session fits into the
full-day schedule, and for the source material this deck is adapted
from (mainly =slide/2020_ERAD_STARPU.org= and Samuel Thibault's
=prev-slides/26-web.odp=, both in Portuguese/English research-seminar
form — this deck is a fresh, English, 90-minute-paced rewrite, not a
translation).
